...
m = VIPModel()
@variable(m, -100 <= x[1:5] <= 0)
@NLexpression(m, F[i=1:5], sum{A[i,j]*x[j], j=1:5} - b[i] )
@NLconstraint(m, x[1]^2 + x[2]^2 + 2x[3]^2 + x[4]^2 - 5x[1] - 5x[2] - 21x[3] + 7x[4] + x[5] <= 0 )
@NLconstraint(m, 4x[1]^2 + 4x[2]^2 + 5x[3]^2 + 4x[4]^2 - 2x[1] - 8x[2] - 18x[3] + 4x[4] + x[5] - 24 <= 0 )
@NLconstraint(m, 4x[1]^2 + 7x[2]^2 + 5x[3]^2 + 7x[4]^2 - 8x[1] - 5x[2] - 21x[3] + 4x[4] + x[5] - 30 <= 0 )
@NLconstraint(m, 7x[1]^2 + 4x[2]^2 + 5x[3]^2 + x[4]^2 + x[1] - 8x[2] - 21x[3] + 4x[4] + x[5] - 15 <= 0 )
